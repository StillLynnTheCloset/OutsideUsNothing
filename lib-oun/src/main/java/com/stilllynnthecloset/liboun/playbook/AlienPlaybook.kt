    ...
    public val aliens: List<PlaySheetSpecification> = listOf(
        PlaySheetSpecification(
            ...
            flavorText = FlavorText(
                text = "“Earth? No, never heard of it. Is that one of those bits of corporate propaganda? That we all came from one world before slow generation ships? Prelapsarian BS.”",
                attribution = "From an interview of a psychogogic manipulation addict in corporate space",
            ),
            choices = listOf(
                ChoiceSpecification(
                    options = setOf(
        ...
        PlaySheetSpecification(
            ...
            flavorText = FlavorText(
                text = "“Lo brethren! We are cast out in this universe of dark! Rise up! Rise together for the glory of all angel-kind! Become the light that will pierce creation!”",
                attribution = "Horizon Light, propaganda video released by Her Angelic Highness",
            ),
            choices = listOf(
                ChoiceSpecification(
                    options = setOf(
